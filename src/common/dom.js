...
const {isString, isArray, isObject, isFunction, isElement} = _;
...
var $ = (function ()
{
  ...
  Dom.prototype = {
    addClass: function (arg)
    {
      ...
      if (isString(arg))
      {
        arg = _.trim(arg).replace(/\s+/, ' ').split(' ');
      }
    ...
    css: function (arg1, arg2)
    {
      if (arguments.length === 1)
      {
        ...
        else if (isObject(arg1))
        {
          this.each(function (el)
          {
            _.each(arg1, function (value, key)
            {
              el.style[key] = value;
            });
          });
